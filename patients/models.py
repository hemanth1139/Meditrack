...
class OTPConsent(models.Model):
    """OTP consent records for cross-hospital patient access."""

    patient = models.ForeignKey(Patient, on_delete=models.CASCADE, related_name="otp_consents")
    requested_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        related_name="otp_requests",
    )
    requesting_hospital = models.ForeignKey(Hospital, on_delete=models.CASCADE, related_name="otp_requests")
    ...
    def __str__(self) -> str:
        return f"OTPConsent for {self.patient.patient_id} requested by {self.requested_by_id}"
