...
class MedicalRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "visit_type", "sub_type", "is_followup", "visit_date", "status", "flag_reason",
            "record_hash", "prev_hash", "created_at", "approved_at",
            "prescriptions", "documents",
            # General
            "chief_complaint", "history", "symptoms", "symptom_duration",
            "examination_findings", "diagnosis", "suspected_diagnosis", "severity", "treatment_given", "doctor_notes",
            # Lab
            "clinical_indication", "tests_ordered", "priority", "fasting_required",
            "fasting_hours", "lab_instructions", "lab_results", "results_interpretation",
            # Scan
            ...
            # Emergency
            "arrival_time", "triage_level", "mode_of_arrival", "vitals", "gcs_score", "disposition",
            # Follow-up
