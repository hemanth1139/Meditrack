  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-50 font-sans">
      ...
      >
        ...
        >
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              {errors.email && (
                <motion.p initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} className="text-[13px] font-medium text-red-500">
            ...
            <motion.div variants={itemVariants} className="pt-4 text-center text-[14px] font-medium text-slate-500">
        ...
        <motion.div variants={itemVariants} className="mt-8 text-center text-[13px] font-medium text-slate-400">
